...
<body>
    ...
    <button class="print-fab" onclick="window.print()">
        <svg width="20" height="20" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24">
            <path d="M6 9V2h12v7M6 18H4a2 2 0 01-2-2v-5a2 2 0 012-2h16a2 2 0 012 2v5a2 2 0 01-2 2h-2m-2 4H6v-4h12v4z">
            </path>
        </svg>
        Print / Save PDF
    </button>
    ...
    <div class="admit-card">
        ...
        <div class="masthead">
            <div class="masthead-logo">
                <img src="assets/logo.svg" alt="Doon University">
            </div>
        ...
        <div class="doc-title-wrapper">
            <div class="doc-title-main">Provisional Admit Card</div>
            <div class="doc-meta">
                <div class="doc-title-session">Session 2025–26</div>
                <div class="doc-title-exam">Semester Examinations — May <?= date('Y') ?></div>
            </div>
        </div>
            ...
            <div class="ib-data">
                ...
                <div class="ib-hero">
                    <div class="ib-name-zone">
                        ...
                        <div class="ib-programme"><?= htmlspecialchars($student['course'] ?? 'N/A') ?> · Dept. of
                            <?= htmlspecialchars($student['department_name'] ?? 'N/A') ?></div>
                    </div>
                    <div class="ib-roll-zone">
                        <div class="roll-label">Roll No.</div>
                        <div class="roll-value">
                            <?= htmlspecialchars($student['roll_no'] ?? $student['enrollment_no'] ?? '—') ?></div>
                    </div>
                </div>
                ...
                <div class="ib-details">
                    ...
                    <div class="d-row">
                        ...
                        <span
                            class="d-val"><?= htmlspecialchars(($student['dob'] ?? 'N/A') . ' / ' . ($student['gender'] ?? 'N/A')) ?></span>
                    </div>
                    <div class="d-row">
                    ...
                    <div class="d-row">
                        ...
                        <span
                            class="d-val"><?= htmlspecialchars($student['mobile'] ?? $student['phone'] ?? 'N/A') ?></span>
                    </div>
